...
SELECT * FROM tb_alunos WHERE idade BETWEEN 18 and 29 ORDER BY nome ASC;  #ASC = alfabético, valor default
SELECT * FROM tb_alunos WHERE idade BETWEEN 18 and 29 ORDER BY nome DESC;  #DESC = alfabético decrescente
